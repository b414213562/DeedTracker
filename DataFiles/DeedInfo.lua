...
_DEED_LOG_PAGE_TAB_CONTENTS = {
    ...
    [CLASS_RACE_EPIC] = {
        ...
        [CRE_CLASS] = {
          ...
          [489] = {["ID"] = 1879051909; }; -- Arrow-storm (lvl 20)
          [490] = {["ID"] = 1879051910; }; -- Deep Concentration (lvl 20)
          [491] = {["ID"] = 1879051911; }; -- Deadly Precision (lvl 20)
          [492] = {["ID"] = 1879051912; }; -- True Shot (lvl 20)
          [493] = {["ID"] = 1879051913; }; -- Springloaded Traps (lvl 30)
          [494] = {["ID"] = 1879051914; }; -- Stealthy Shot (lvl 30)
          [495] = {["ID"] = 1879051915; }; -- Swift Recovery (lvl 30)
          [496] = {["CAT_ID"] = 317; }; -- Rune-keeper
          [497] = {["ID"] = 1879139170; }; -- Master of Allusion (lvl 1)
          [498] = {["ID"] = 1879139161; }; -- Tale of Rage (lvl 1)
          [499] = {["ID"] = 1879139173; }; -- Thunderous Words (lvl 1)
          [500] = {["ID"] = 1879139174; }; -- Winter-storm (lvl 1)
          [501] = {["ID"] = 1879139162; }; -- Conflagration of Runes (lvl 10)
          [502] = {["ID"] = 1879139158; }; -- Confounding Principles (lvl 10)
          [503] = {["ID"] = 1879139167; }; -- Memorable Prose (lvl 10)
          [504] = {["ID"] = 1879139168; }; -- Rune of Endurance (lvl 10)
          [505] = {["ID"] = 1879139156; }; -- Frost-burn (lvl 20)
          [506] = {["ID"] = 1879139171; }; -- Harsh Debate (lvl 20)
          [507] = {["ID"] = 1879139160; }; -- The Prophetic Word (lvl 20)
          [508] = {["ID"] = 1879139164; }; -- Writ of Blazing Fire (lvl 20)
          [509] = {["ID"] = 1879139165; }; -- Icy Discourse (lvl 30)
          [510] = {["ID"] = 1879139154; }; -- Linnod of Peace (lvl 30)
          [511] = {["ID"] = 1879139159; }; -- Linnod of Subtlety (lvl 30)
          [512] = {["ID"] = 1879139157; }; -- Overflowing Confidence (lvl 30)
          [513] = {["ID"] = 1879139172; }; -- Closing Remarks (lvl 40)
          [514] = {["ID"] = 1879139163; }; -- Scathing Retort (lvl 40)
          [515] = {["ID"] = 1879139166; }; -- Terse Narrative (lvl 40)
          [516] = {["ID"] = 1879139169; }; -- Author of Exaltation (lvl 50)
          [517] = {["ID"] = 1879139153; }; -- Master of Connotation (lvl 50)
          [518] = {["ID"] = 1879139155; }; -- Master of Tragedy (lvl 50)
