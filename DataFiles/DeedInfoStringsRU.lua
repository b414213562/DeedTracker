...
_FACTIONS = {
    ...
    [1879463136] = "Восстановленный Гондор";
    [1879465745] = "Жители Умбар-Бахарбеля";
    [1879489736] = "Жители Икорбана";
    [1879506198] = "Темамиры Джирет-Менеша";
    [1879506206] = "Город Заджана";
    [1879506212] = "Кинтайцы Сул-Мадаша";
    [1879508769] = "Возрождённый Хамат";
};
_CLASSES = {
     [23] = "Страж";
     [24] = "Рыцарь";
