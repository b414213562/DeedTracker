...
_CONFLICTING_QUEST_NAME_TO_ID = {
    ...
    ["Битва за Двадцать первый чертог"] = 1879198363; -- Deed ID: 1879202439
    ["Битва за Осгилиат"] = 1879326193; -- Deed ID: 1879326392
    ["Бич ордахцев"] = 1879490363; -- Deed ID: 1879491696
    ...
    ["Торжество жизни"] = 1879516436; -- Deed ID: 1879175094
...
_CONFLICTING_QUESTS = {
    ...
    -- Схватка / Схватки / Битва за Двадцать первый чертог
    [1879198363] = {
        ["ISREPEATABLE"] = true;
    ...
    -- Харадвайт / Ураш-Дар / Бич ордахцев
    [1879490363] = {
        ["ISREPEATABLE"] = false;
        ["QUESTNAME"] = "Долина Икорбан: Имхулар / Бич ордахцев\n    (Артар Ильдартос просит вас помочь клану Адурхид в Вартулине выиграть время, убивая ордахцев, воюющих с ними в Гат-Лоре.)";
    };
    ...
    -- Схватка / Схватки / Торжество жизни
    [1879516436] = {
        ["ISREPEATABLE"] = false;
        ["QUESTNAME"] = "Мур-Гала: Идагал / Торжество жизни\n    (После спасения из тюрьмы несколько сказителей хотят отблагодарить вас единственной наградой, которую они способны предложить - историями о своей родине. Сейчас они отдыхают в относительной безопасности Ахабы.)";
    };
