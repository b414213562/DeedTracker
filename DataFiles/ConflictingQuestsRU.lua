-- auto-generated by Cube's CompanionDataParser tool at 2025-09-01 23:18:59
...
_CONFLICTING_QUEST_NAME_TO_ID = {
    ...
    ["Бич ордахаев"] = 1879490363; -- Deed ID: 1879491696
...
_CONFLICTING_QUESTS = {
    ...
    -- Харадвайт / Urash Dâr / Бич ордахаев
    [1879490363] = {
        ["ISREPEATABLE"] = false;
        ["QUESTNAME"] = "Долина Икорбан: Имхулар / Бич ордахаев\n    (Артар Ильдартос просит вас помочь клану Адурхид в Вартулине выиграть время, убивая ордахаев, воюющих с ними в Гат-Лоре.)";
    };
